...
single-page application (SPA). I decided to use Durandal as the MVVM framework because it's easy to understand and 
configure due to the convention-based approach it uses in binding view-models to views. It's also built on using 
promises in its composition and binding control-flow, which I am very impressed with.
...
stopped and looked for a way to modularize this code so that I could reuse it. Inheritance almost immediately came to 
...
Here's a jsFiddle of this example, with a little more added to it. For me, it works out really well. I'm pleased with 
the results so far. Eventually, I'll have this project re-factored and then I can ask my users to take it for a spin and 
let me know what they think of the improvements. Cheers!
